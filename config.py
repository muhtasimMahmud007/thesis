...
__C.DATASETS.PASCAL3D.TAXONOMY_FILE_PATH    = '/content/thesis/datasets/Pascal3D.json'
...
__C.DATASETS.PIX3D.TAXONOMY_FILE_PATH       = '/content/thesis/datasets/Pix3D.json'
